"""Render rotation GIF from Run 10 (Meshy API assets, 25 rounds)."""
import os
import subprocess
import sys
import tempfile
...
RUN_DIR = Path(r"D:\Projects\ProjectGenesis\GenesisVIGA\output\static_scene\20260209_025812\greentea")
