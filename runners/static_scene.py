...
def main() -> None:
    ...
    parser.add_argument("--prompt-setting", choices=["none", "procedural", "scene_graph", "get_asset", "get_asset_simple", "get_asset_sam3d"], default="none", help="Setting for the prompt")
